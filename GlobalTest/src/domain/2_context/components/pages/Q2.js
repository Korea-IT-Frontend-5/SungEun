...
import { add_form, add_isEdit, reset_form, useUserFormDispatch, useUserFormState, view_form } from "../../../../store/3_context";
...
const ContextQ2Page = () => {
  ...
  */
  ...
  const onAddIsEdit = (isEdit) => {
    dispacth(add_isEdit(isEdit));
  }
  ...
  return (
    <>
      <h2>문제 2 - 2</h2>
      <ContextQ2Form onAddForm={onAddForm} onAddIsEdit={onAddIsEdit} onListView={onListView} />
