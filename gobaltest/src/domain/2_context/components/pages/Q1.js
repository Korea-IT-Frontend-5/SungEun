...
import { ModalContext, ModalDispatch } from "../../../../store/2_context";
...
const ContextQ1Page = () => {
  ...
  const setIsModalOpen = useContext(ModalDispatch);
  ...
  return (
    <div>
      ...
      <h2>문제 2 - 1</h2>
      <ContextQ1Detail onModal={onModal} isModalOpen={isModalOpen} />
